 ...
 *   vaultModule / DSH_RELAY_VAULT_MODULE  optional python module exposing
 *        reveal_entry(name) -> (ok, value), used to resolve secretRef from a
 *        self-hosted credential vault (never built in)
 *   circleMembers / DSH_RELAY_CIRCLE_MEMBERS  optional roster listed in the
 *        system-prompt guidance and the send-tool description
 *
